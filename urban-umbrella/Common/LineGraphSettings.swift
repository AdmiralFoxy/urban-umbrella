...
public struct Line: View {
    @ObservedObject var data: LineData
    ...
    public var body: some View {
        ZStack {
            ...
            self.path
                ...
                .stroke(LinearGradient(gradient: Gradient(colors: [self.lineColor]), startPoint: .leading, endPoint: .trailing) ,style: StrokeStyle(lineWidth: 3, lineJoin: .round))
                .rotationEffect(.degrees(180), anchor: .center)
                .rotation3DEffect(.degrees(180), axis: (x: 0, y: 1, z: 0))
            ...
            if (self.showIndicator) {
                IndicatorPoint(color: $lineColor)
                    .position(CGPoint(x: path.boundingRect.width, y: path.currentPoint!.y))
                    .rotationEffect(.degrees(180), anchor: .center)
                    .rotation3DEffect(.degrees(180), axis: (x: 0, y: 1, z: 0))
            }
        }
